...
DATASET_NAME = "glue"  # 一组NLP评测任务  General Language Understanding Evaluation benchmark
...
def predict(text1, text2):
    inputs = tokenizer(text1, text2, truncation=True, max_length=128, return_tensors="pt")
    ...
    print('current logits are, ', logits )
    predicted_class = torch.argmax(logits, dim=1).item()
    return predicted_class


# Example usage
text1 = "He took batting practice on the field for the second time Tuesday since his opening-day injury"
text2 = "On Tuesday, he took batting practice on the field for just the second time since he was injured on opening day"
text3 = "Jeter , who dislocated his left shoulder in a collision March 31 , took batting practice on the field for the first time Monday ."

predicted_class_1 = predict(text1, text2)
predicted_class_2 = predict(text1, text3)
print(f"Predicted Class same: {predicted_class_1}")
print(f"Predicted Class different: {predicted_class_2}")
